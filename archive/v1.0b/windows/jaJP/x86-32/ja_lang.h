...
wstring DC001_ASINPABOUT = L"asin [タイプ] [x]         -> 正弦を計算します。 デフォルトのタイプは度です (deg)、 [タイプ] = deg, rad or gra";
wstring DC001_ACOSPABOUT = L"acos [タイプ] [x]         -> 余弦を計算します。 デフォルトのタイプは度です (deg)、 [タイプ] = deg, rad or gra";
wstring DC001_ATANPABOUT = L"atan [タイプ] [x]         -> 正接を計算します。 デフォルトのタイプは度です (rad)、 [タイプ] = deg, rad or gra";
