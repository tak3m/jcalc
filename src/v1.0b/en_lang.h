...
wstring MSG07_NUMTOOLONG = L"Number too long";
...
wstring DC001_COSOPABOUT = L"cos  [type] [x]         -> Calculate cosine of an angle. Default type is degrees (deg), [type] = deg, rad or gra";
wstring DC001_TANOPABOUT = L"tan  [type] [x]         -> Calculate tangent of an angle. Default type is degrees (deg), [type] = deg, rad or gra";
wstring DC001_ASINPABOUT = L"asin [type] [x]         -> Calculate arcsine. Default type is degrees (deg), [type] = deg, rad or gra";
wstring DC001_ACOSPABOUT = L"acos [type] [x]         -> Calculate arccosine. Default type is degrees (deg), [type] = deg, rad or gra";
wstring DC001_ATANPABOUT = L"atan [type] [x]         -> Calculate arctangent. Default type is degrees (rad), [type] = deg, rad or gra";

wstring DC001_PRCVTTOOLS = L"cvt [type1] [type2] [x] -> Convert between numeral systems. Types include 'hex' for Hexadecimal, 'dec' for Decimal, 'oct' for Octal and 'bin' for Binary";

//about
wstring VER00_AUTHORWHAT = L"by tachikawa20";
wstring VER01_LICENSEWHO = L"Protected by GPL v3 license.";
wstring VER02_RELEASEDAT = L"2020/11";
wstring VER03_MOTTOABOUT = L"Aiming for maximum compatibility. Always.";
